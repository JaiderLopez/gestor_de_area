  ...
  return (
    <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      <div className="sidebar-header">
        ...
        <button className="collapse-btn" onClick={toggleSidebar} title={isCollapsed ? "Expandir" : "Contraer"}>
          {isCollapsed ? '➡' : '⬅'}
        </button>
      </div>
      <nav className="sidebar-nav">
        <ul>
          ...
          <li>
            <NavLink to="/discos" className={({ isActive }) => (isActive ? 'active' : '')} title="Gestor de Discos">
              <span className="icon">💾</span>
              {!isCollapsed && <span className="link-text">Gestor de Discos</span>}
            </NavLink>
          </li>
          <li>
            <NavLink to="/inventario" className={({ isActive }) => (isActive ? 'active' : '')} title="Inventario">
              <span className="icon">🖥️</span>
              {!isCollapsed && <span className="link-text">Inventario</span>}
            </NavLink>
          </li>
          <li>
            <NavLink to="/reportes" className={({ isActive }) => (isActive ? 'active' : '')} title="Reportes">
              <span className="icon">📊</span>
              {!isCollapsed && <span className="link-text">Reportes</span>}
            </NavLink>
          </li>
          <li>
            <NavLink to="/mantenimiento" className={({ isActive }) => (isActive ? 'active' : '')} title="Mantenimiento">
              <span className="icon">🛠️</span>
